...
1. **Pentarch Signal Flow** → `pentarch-v10/index.html` ✅
2. **Indicator Selection Decision Tree** → `ref-comparison/index.html` ✅ (YOU LOVED THIS!)
3. **Alert Setup Workflow** → `how-to-alerts/index.html` ✅

---

## 🎯 Recommended Additions (8 more)

### Priority 1: Product Pages (Make Each Product Visual)

#### 4. **Harmonic Oscillator Voting System** → `harmonic-oscillator-v10/index.html`
...
#### 5. **Omnideck System Layers** → `omnideck-v10/index.html`
...
#### 6. **Janus Atlas Level Types** → `janus-atlas-v10/index.html`
...
#### 7. **Plutus Flow OBV Analysis** → `plutus-flow-v10/index.html`
- **Shows:** OBV calculation → smoothing → analysis → signals
- **Add after:** "How It Works" section
- **Why:** Explains the adaptive smoothing feature visually

#### 8. **Augury Grid Workflow** → `augury-grid-v10/index.html`
- **Shows:** 8 symbols → scanning → signal display → priority actions
...
#### 10. **Trading Workflow (Bias → Timing)** → `ref-workflow/index.html`
- **Shows:** Complete trading process: HTF bias → setup → timing → entry → exit
- **Add at:** Very top of page (hero section)
- **Why:** This is a reference page - diagram IS the content!

#### 11. **Configuration Recipes Flow** → `ref-configuration-recipes/index.html` (if you create this page)
- **Shows:** Choose style → timeframe → frequency → apply → backtest
- **Add at:** Top of page
...
- 📚 Less overwhelming (diagram > 3 paragraphs)
- 💡 Better retention (remember pictures > words)
...
**Want me to add them now? I can create a script to add all 7 in one shot! 🚀**
